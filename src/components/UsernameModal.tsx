        ...
        >
          ...
          <div className="p-8 pt-12 space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-xs text-fg-muted font-bold uppercase tracking-widest text-[10px]">Every legend needs a name. What's yours?</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 text-fg-muted" size={16} />
                  <input
                    type="text"
                    value={username}
                  ...
                  <div className="absolute right-4 top-1/2 -translate-y-1/2">
                    {checking ? (
                      <Loader2 className="animate-spin text-fg-muted" size={16} />
                    ) : isAvailable === true ? (
              ...
              <div className="space-y-2">
                <label className="text-[10px] text-fg-muted font-black uppercase tracking-widest ml-1">Date of Birth</label>
                <div className="relative">
                  <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-fg-muted" size={16} />
                  <input
                    type="text"
                    value={dob}
                    ...
                    className={`w-full bg-white/[0.03] border rounded-2xl py-4 pl-12 pr-4 text-fg-primary text-xs font-bold focus:outline-none transition-all ${
                      isDobValid === true ? 'border-accent-default/50 focus:border-accent-default' : 
              ...
              <div className="space-y-2">
                <label className="text-[10px] text-fg-muted font-black uppercase tracking-widest ml-1">Gender</label>
