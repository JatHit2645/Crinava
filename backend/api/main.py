...
from backend.utils.hub import load_cache, save_cache, match_hub  # noqa: E402
...
from backend.api.cors_config import get_allowed_origins
        ...
        for match in discovery_engine.live_matches:
            ...
            if match_id not in match_hub or not match_hub[match_id].get("worker"):
                ...
                if match["source"] == "crex":
                    ...
                    from backend.services.crinava_worker import HierarchyScraperWorker
